...
## Project Structure
    ...
    ├── testapiautostoryboa_85718  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_85718`
...
2. Clone this repo and `cd testapiautostoryboa_85718`
